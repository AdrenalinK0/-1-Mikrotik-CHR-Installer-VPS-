...
echo
echo "=== Bandrew hengker ff ==="
echo "=== https://github.com/andrewlewa==="
echo "=== MikroTik 7 patch Installer ==="
echo
sleep 3
wget https://github.com/elseif/MikroTikPatch/releases/download/7.11.3/chr-7.11.3-legacy-bios.img.zip -O chr.img.zip  && \
